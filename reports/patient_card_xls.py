...
#     _name = "reports.om_hospital.report_patient_id_card_xls"
#     _inherit = "reports.report_xlsx.abstract"
#
#     def generate_xlsx_report(self, workbook, data, patients):
#         bold = workbook.add_format({'bold': True})
#         format_l = workbook.add_format({'bold': True, 'align': 'centre', 'bg_color': 'yellow'})
#
#         for obj in patients:
...
#
#             row += 2
#             sheet.merge_range(row, col, row + 1, col + 1, '', format_l)
